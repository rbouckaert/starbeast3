...
**Step 2.2.** Install the latest versions of **StarBeast3** and **bModelTest**. This is done through `File => Manage Packages`. You will need to restart BEAUti for this to take effect.
...
**Step 2.16.** Save the XML file `File => Save`. 
...
**Step 3.1.** In the command line, or using the graphical user interface, run beast on the primates.xml file. It should take around 5-10 minutes for the experiment to finish, however you can begin the next steps while you wait.

![Setting species to individual mapping](figs/fig4.png)
...
**Question 4.5.** bModelTest: what is the best substitution model for each partition. Is there any site rate heterogeneity? Are the nucleotide frequencies uniform?
...
**Question 4.7.** What are the clade supports like on this tree? Is the phylogeny well-supported? What could be done to increase the clade support?
