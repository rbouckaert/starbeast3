...
public class BactrianUpDownOperator extends GTKOperator {
    ...
    List<StateNode> ups;
    List<StateNode> downs;
    
    
    // List of gene tree kernels which are to be moved up or down
    List<GTKPrior> gtkUps;
    List<GTKPrior> gtkDowns;
	...
	/**
	 * If there is a gene tree kernel in the up or down, then remove this element and replace with the list of trees
	 */
	private void addGeneTreesToUpDown() {
