...
public class SpeciesTreePrior extends TreeDistribution {
    ...
    public final Input<RealVectorParam<NonNegativeReal>> popSizesBottomInput = new Input<>("bottomPopSize", "population size parameter for populations at the bottom of a branch. " +
            "For linear population function, this is the same at the top of the branch.", Validate.REQUIRED);
    public final Input<RealVectorParam<NonNegativeReal>> popSizesTopInput = new Input<>("topPopSize", "population size parameter at the top of a branch. " +
            "Ignored for constant population function, but required for linear population function.");

    public final Input<RealScalarParam<NonNegativeReal>> gammaParameterInput = new Input<>("gammaParameter", "scale parameter of the gamma distribution over population sizes. "
...
//	public Input<RealParameter> m_rootHeightParameter = new Input<>("rootBranchHeight","height of the node above the root, representing the root branch", Validate.REQUIRED);
    ...
    private RealVectorParam<NonNegativeReal> popSizesBottom;
    private RealVectorParam<NonNegativeReal> popSizesTop;
    ...
    public void initAndValidate() {
        ...
        final RealScalarParam<NonNegativeReal> parameter = new RealScalarParam<>();
        parameter.set(4.0);
    ...
    public RealVectorParam<NonNegativeReal> getPopulationSizes() {
